              ...
              // When clicked, show a dialog with event information
    			...
    			dialogButton.setOnClickListener(new OnClickListener() {
    				...
    				public void onClick(View v) {
    					...
    					int finishMinute = 0;
    					int finishHour = 0;
    					if (newTime.equals("Mid-Day: (11:30AM - 1:30PM)")){
							startHour = 11;
							startMinute = 30;	
							finishHour = 13;
							finishMinute = 30;
						}
						if (newTime.equals("Evening: (5:30PM - 7:30PM)")){
							startHour = 17;
							startMinute = 30;	
							finishHour = 19;
							finishMinute = 30;
						}
						if (newTime.equals("Night: (8:30PM - 10:30PM)")){
							startHour = 20;
							startMinute = 30;	
							finishHour = 22;
							finishMinute = 30;
						}
						if (newTime.equals("Morning: (6AM - 11:30AM)")){
							startHour = 6;
							startMinute = 30;	
							finishHour = 11;
							finishMinute = 30;
						}
						if (newTime.equals("Late Night: (11:30PM - 2:00AM)")){
							startHour = 20;
							startMinute = 30;	
							finishHour = 23;
							finishMinute = 59;
